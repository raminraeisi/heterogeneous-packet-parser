...
if exist "%InstallDir%\MSBuild\Current\Bin\MSBuild.exe" ("%InstallDir%\MSBuild\Current\Bin\MSBuild.exe" "vs\assessment.vcxproj" "/p:Configuration=Release" "/p:OutDir=../output/") else (echo Sorry, can not find Viual Studio installation path)
